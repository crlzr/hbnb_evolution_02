...
class Place(Base):
    ...
    if USE_DB_STORAGE:
        ...
        owner = relationship("User", back_populates="properties", foreign_keys=[__host_id])
        location_city = relationship("City", back_populates="apartment", foreign_keys=[__city_id])
